...
using use = useUsing("use")`,
  ...
  [SkillNames.CSHARP]: {
    ...
    name: "csharp",
    label: "C#",
    shortDescription: "Strongly typed, object-oriented, and ready to ship! 🎯💻",
    color: "#9b4f96",
  ...
  [SkillNames.DOTNET]: {
    ...
    name: "dotnet",
    label: ".NET",
    shortDescription: "Microsoft's powerhouse framework, enterprise-grade! 🏗️🔥",
    color: "#512bd4",
  ...
  [SkillNames.SQL]: {
    ...
    name: "sql",
    label: "SQL",
    shortDescription: "Querying data like a boss, SELECT * FROM skills! 🗃️⚡",
    color: "#e38c00",
  ...
  [SkillNames.PHP]: {
    ...
    name: "php",
    label: "PHP",
    shortDescription: "Backend logic and WordPress magic! 🐘",
    color: "#777bb4",
  ...
  [SkillNames.SEMRUSH]: {
    ...
    name: "semrush",
    label: "Semrush",
    shortDescription: "SEO keyword analysis and strategy 📈",
    color: "#ff642d",
  ...
  [SkillNames.GA]: {
    ...
    shortDescription: "Tracking metrics and user behavior 📊",
    color: "#e37400",
    icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/google/google-original.svg",
  },
  [SkillNames.GTM]: {
    ...
    name: "gtm",
    label: "GTM",
    shortDescription: "Deploying tracking tags seamlessly 🏷️",
    color: "#4285F4",
    icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/google/google-original.svg",
  },
};
...
export const EXPERIENCE: Experience[] = [
  {
    ...
    startDate: "Oct 2024",
    endDate: "Dec 2025",
    title: "Frontend Developer / SEO Assistant",
    company: "Gemini Infotech",
    description: [
      "Worked on production-level web applications in the iGaming industry.",
      "Actively participated in debugging and analyzing system issues and workflows.",
      "Identified inconsistencies and potential problems in application logic and user flows.",
      "Collaborated with developers to improve system stability and reliability.",
      "Maintained clear documentation of issues, fixes, and changes.",
