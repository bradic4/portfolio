...
const projects: Project[] = [
  {
    ...
    src: "/assets/projects-screenshots/marketing-dashboard/landing.png",
      ...
      return (
        <div>
          <TypographyP className="font-mono text-2xl text-center">
            Modular C# Reporting Engine
          </TypographyP>
          <TypographyP className="font-mono ">
            A modular C# application designed for generating and analyzing
            marketing data and reports. The system processes API data and
            structures it using Object-Oriented Programming principles to
            ensure maintainability and scalability.
          </TypographyP>
          <ProjectsLinks repo={this.github} />
          <TypographyH3 className="my-4 mt-8">Architecture & Design</TypographyH3>
          <p className="font-mono mb-2">
            Built from the ground up using C# and .NET fundamentals, the
            application follows clean OOP principles with well-defined class
            hierarchies, interfaces, and separation of concerns. Each module
            handles a specific domain — data retrieval, transformation, and
            report generation — making the codebase easy to extend and test.
          </p>
          <TypographyH3 className="my-4 mt-8">API Integration</TypographyH3>
          <p className="font-mono mb-2">
            Integrated API-based data retrieval to pull marketing metrics from
            external sources. The data pipeline handles authentication, rate
            limiting, and error recovery, ensuring reliable data ingestion
            even under adverse network conditions.
          </p>
          <TypographyH3 className="my-4 mt-8">Data Processing & SQL</TypographyH3>
          <p className="font-mono mb-2">
            Leverages SQL for structured data storage and complex analytical
            queries. The reporting layer transforms raw marketing data into
            actionable insights through aggregation, filtering, and
            trend analysis — delivering reports that drive business decisions.
          </p>
          <TypographyH3 className="my-4 mt-8">Engineering Focus</TypographyH3>
          <p className="font-mono mb-2">
            This project emphasizes software engineering discipline:
            comprehensive debugging practices, maintainable architecture,
            and code that&apos;s built to evolve. Every component is designed
            with testability and extensibility in mind.
          </p>
        </div>
      );
    },
